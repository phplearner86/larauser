   ...
   <form action="{{ route('createSchedule', $profile->id) }}" method="POST">
        ...
        <div class="col-md-6">
            <div id="createDays">
                ...
                @foreach ($days = $profile->days as $d)
                <div class="row day" >
                    <div class="form-group">
                        ...
                        <div class="flex">
                            ...
                            <input type="text" class="form-control ml-2" placeholder="00:00" name="start[]" value="{{ $d->pivot->start }}">
                            <input type="text" class="form-control ml-2" placeholder="00:00" name="end[]" value="{{ $d->pivot->end }}">
                            <button type="button" class="btn btn-success ml-2" id="addMore">Add</button>
                        </div>
                    </div>
                </div>
                @endforeach
